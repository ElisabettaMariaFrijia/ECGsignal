function ecg_spec_rect(fname,T,figno)
%function ecg_spec_rect(fname,T,figno)
%La funzione esegue la stima spettrale con finestra rettangolare, fname è
...
title ( 'Stima spettrale con finestra rettangolare del segnale ECG');
grid on;
